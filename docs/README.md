...
| 중앙 error code catalog | `contracts/error-code-catalog.md` |
...
| 두블룬 내부 승인 워크플로 구현·검증 상태 | `contracts/doubloon-approval-workflow.md` |
