...
- challenge 결과는 인증, 권한, 결제 또는 제품 domain action 승인이 아니며 verification receipt는 exact product/environment/action과 consumer operation에 묶어 짧은 수명으로 소비하고 같은 operation만 성공 replay한다.
