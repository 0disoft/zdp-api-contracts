...
| 루트 `service.yaml` manifest 또는 CI gate | GitHub Actions `Validate service catalog manifest` step, using `0disoft/service-catalog-generator@v0.5.9` with `input-schema: zdp-v2` |
...
- service catalog compile source: root `service.yaml`, consumed by `0disoft/service-catalog-generator@v0.5.9` in GitHub Actions
