...
- verification receipt가 exact product/environment/action binding, 짧은 TTL, consumer operation-bound 소비, 같은 operation의 성공 replay와 다른 operation의 fail-closed 거부를 유지하는지 확인한다.
